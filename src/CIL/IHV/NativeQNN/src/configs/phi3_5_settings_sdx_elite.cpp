...
namespace infer {
std::string LlmInference::formConfigStringPhi3_5_SDX_Elite(
  ...
  if (device_type_ == "NPU_CPU") {
    ...
    engine["model"]["positional-encoding"] = {
        {"type", "rope"}, {"rope-dim", 48}, {"rope-theta", 10000}};
    engine["model"]["positional-encoding"]["rope-scaling"] = {
        {"rope-type", "longrope"},
        {"factor", 32},
        {"original-max-position-embeddings", 4096},
        {"long-factor",
         nlohmann::json::basic_json::array(
             {1.0800000429153442, 1.1100000143051147, 1.1399999856948853,
              ...
              64.51000213623047,  64.52999877929688,  64.83999633789062})},
        {"short-factor",
         nlohmann::json::basic_json::array({1.0,
                                            1.0199999809265137,
                                            1.0299999713897705,
                                            1.0299999713897705,
                                            1.0499999523162842,
