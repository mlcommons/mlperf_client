...
elseif(APPLE)
    # Determine platform and architecture for macOS or iOS
    if(CMAKE_OSX_SYSROOT STREQUAL "iphoneos")
        set(OpenSSL_ROOT_DIR "${CMAKE_CURRENT_LIST_DIR}/iOS/ARM")
    else()
...
elseif(LINUX)
    set(OpenSSL_ROOT_DIR "${CMAKE_CURRENT_LIST_DIR}/Linux")
    if(CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "arm" OR CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "aarch64")
        set(OpenSSL_ROOT_DIR "${OpenSSL_ROOT_DIR}/ARM")
    else()
        set(OpenSSL_ROOT_DIR "${OpenSSL_ROOT_DIR}/x64")
    endif()
else()
