...
if model_name == "llama3.1":
    ...
    modify_notebook("qnn_model_prepare_multigraph.ipynb", "updated_qnn_model_prepare_multigraph.ipynb", parameters)
    pm.execute_notebook(
        "updated_qnn_model_prepare_multigraph.ipynb",
        "output_qnn_model_prepare_multigraph.ipynb",
        kernel_name="python",
        execution_timeout=-1
    )
elif model_name == "phi4":
