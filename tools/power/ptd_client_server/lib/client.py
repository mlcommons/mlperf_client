...
def find_loadgen_logs(
    path: str, loadgen_log_file: str, loadgen_other_files: list, time_load_start: float, time_load_end: float
) -> Optional[str]:
...
def main() -> None:
    ...
    for mode in needed_modes:
        ...
        loadgen_logs = find_loadgen_logs(
            args.loadgen_logs, args.loadgen_log_file, args.loadgen_other_files, time_load_start, time_load_end
        )
        ...
        os.mkdir(out)
        for file in [args.loadgen_log_file] + args.loadgen_other_files:
